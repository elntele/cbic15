...
public class XYGraphCanvas extends JComponent {
	private String title = "Distribuição de graus dos nós";
...
//		axis.setTickLabelFont(new Font("Lucida Sans Unicode", Font.PLAIN, 18));
	...
	/**
	 * Método acessor para obter o valor do atributo values.
	 * 
	...
	/**
	 * Método acessor para alterar o valor do atributo values.
	 * 
	 * @param values
