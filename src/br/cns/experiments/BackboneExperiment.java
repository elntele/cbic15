...
import br.cns.models.Finland;
import br.cns.models.GenerativeProcedure;
import br.cns.models.NsfNet;
import br.cns.models.PacificBell;
...
public class BackboneExperiment {
	...
	private static void buildResults(List<TMetric> metrics, List<ComplexNetwork> cns) {
		...
		System.out.println("Sumário da rede " + cns.get(0).getModel() + ":");
		int i = 0;
		for (TMetric metric : metrics) {
