package br.cns.experiments.som;
...
import br.cns.experiments.TParameterModel;
...
import br.cns.models.CustomProbabilitiesModel;
...
import br.cns.persistence.RedeKohonenXmlDao;
import br.cns.persistence.ResultSetDaoXml;
import br.cns.persistence.SimonSolutionDao;
import br.cns.som.Neuronio;
import br.cns.som.PadraoTreinamento;
import br.cns.som.RedeException;
import br.cns.som.RedeKohonen;
...
//				e1.printStackTrace();
//				JOptionPane.showMessageDialog(this.btnExportarPng, "Não foi possível carregar o treinamento de SOM.");
//			}
//		}
	}
	...
	public void iniciarExperimento() {
		...
		try {
			System.out.println("Iniciando aprendizado com " + networks.size() + " padrões...");
	...
	private void salvarTreinamento() {
		...
		try {
			...
			e1.printStackTrace();
			JOptionPane.showMessageDialog(this.btnExportarPng, "Não foi possível salvar o treinamento.");
		}
	}
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				JOptionPane.showMessageDialog(this.btnExportarPng,
						"Não foi possível salvar o maps. Escolha outro nome de arquivo.");
			}
		}
	}
