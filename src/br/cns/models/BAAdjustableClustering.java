 ...
 * Arquivo: BAAdjustableClustering.java
 * ****************************************************************************
 ...
 * @since 23/03/2014
 */
public class BAAdjustableClustering extends GenerativeProcedure {
	...
	public BAAdjustableClustering(double density) {
		this.density = density;
	}

	public BAAdjustableClustering(double density, double exponent) {
		this.density = density;
