...
import br.cns.experiments.nodePositions.RandomNodePositions;
...
public class SimpleEdgeDataSet {
	...
	public static ComplexNetwork getTNet(String path, List<TMetric> metrics, String delimiter) throws IOException {
		...
		System.out.println("Repetidos: " + repetidos);
		System.out.println("Edges: " + numEdges);
		System.out.println("Edges únicos: " + (numEdges - repetidos));
...
//		 "% 20818 113 113"},
		...
		for (String[] dataSet : dataSets) {
			System.out.println("Análise do dataset " + dataSet[0]);
...
//		generateErdosRenyi(metrics, nodes, density);
	...
	private static void generateErdosRenyi(List<TMetric> metrics, int nodes, double density) {
		...
		System.out.println("Análise da rede de Erdos-Renyi ");
	...
	private static void generateBarabasi(List<TMetric> metrics, int nodes, double density) {
		...
		System.out.println("Análise da rede de Barabasi");
		...
		System.out.println("\n");
		System.out.println("TLE médio BA = " + tle);
		System.out.println("CC médio BA = " + cc);
		System.out.println("APL médio BA = " + apl);
		System.out.println("HD médio BA = " + hd);
		System.out.println("ENT médio BA = " + ent);
	}
	...
	private static void generateSW(List<TMetric> metrics, int nodes, double density) {
		...
		System.out.println("Análise da rede de WS");
		...
		System.out.println("\n");
		System.out.println("TLE médio WS = " + tle);
		System.out.println("CC médio WS = " + cc);
		System.out.println("APL médio WS = " + apl);
		System.out.println("HD médio WS = " + hd);
		System.out.println("ENT médio WS = " + ent);
		System.out.println();
	}
}
