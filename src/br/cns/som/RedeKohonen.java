...
public class RedeKohonen {
	...
	public void iniciarAprendizado(int numeroIteracoes, double taxaVizinhanca, double taxaAprendizado) throws RedeException {
		// Validando se o padrão de treinamento foi carregado
		if (padroesTreinamento == null || padroesTreinamento.size() == 0) {
			throw new RedeException("Padrão de treinamento não carregado");
		}
		...
		while (iteracaoAtual < numeroIteracoes && taxaAprendizadoIteracao > TX_APREND_MIN && valorAbrangencia > VIZ_MIN) {
			...
			// Realizando uma cópia dos padroes de treinamento
			...
			// O valor de abrangencia é baseado no tamanho da area da camada da saida (taxaVizinhanca x dimensaoCamadaSaida) e na razao das interacoes
			// + Nas interacoes iniciais, a abrangencia é toda a taxaVizinhanca x mapa
			// + Nas interacoes finais, a abrangencia é um percentual pequeno da taxaVizinhanca
			...
			for (int i = 0; i < numeroPadroes; i++) {
				...
				// Lendo o padrão atual de forma aleatória
				...
				// Definindo a área de atualização dos neuronios
		...
		//System.out.println("Tempo de execução (t2): " + t2 + " ms.");
	...
	public void normalizarPadroesTreinamento() {
		...
		// Inicializando os menores e maiores valores de cada dimensão da entrada
		for (int i = 0; i < dimensaoCamadaEntrada; i++) {
			maiorValorEntrada[i] = 0.0;
		}
		
		// Encontrando os menores e maiores valores de cada dimensão da entrada
		for (int iPadrao = 0; iPadrao < padroesTreinamento.size(); iPadrao++) {
			for (int i = 0; i < dimensaoCamadaEntrada; i++) {
		...
		// Normalizando os valores de cada dimensão da entrada
		for (int iPadrao = 0; iPadrao < padroesTreinamento.size(); iPadrao++) {
			for (int i = 0; i < dimensaoCamadaEntrada; i++) {
	...
	/**
	 * Método acessor para obter o valor de dimensaoCamadaEntrada
	 *
	...
	/**
	 * Método acessor para modificar o valor de dimensaoCamadaEntrada
	 *
	...
	/**
	 * Método acessor para obter o valor de dimensaoCamadaSaida
	 *
	...
	/**
	 * Método acessor para modificar o valor de dimensaoCamadaSaida
	 *
	...
	/**
	 * Método acessor para obter o valor de camadaSaida
	 *
	...
	/**
	 * Método acessor para modificar o valor de camadaSaida
	 *
	...
	/**
	 * Método acessor para obter o valor de padroesTreinamento
	 *
	...
	/**
	 * Método acessor para modificar o valor de padroesTreinamento
	 *
	...
	/**
	 * Método acessor para obter o valor de padroesTreinamentoOriginal
	 *
	...
	/**
	 * Método acessor para modificar o valor de padroesTreinamentoOriginal
	 *
