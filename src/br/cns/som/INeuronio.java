...
public class INeuronio {
	...
	private IRedeKohonen rede;
	
	public INeuronio(IRedeKohonen rede, int posX, int posY, int qtdeSinapses) {
		this.rede = rede;
	...
	public double calcularDistanciaEuclidiana(Integer[] padrao, double menorSomaQuadratica) {
	...
	public void atualizarPesos(Integer[] padrao, INeuronio melhorNeuronio, double taxaAprendizado, double valorAbrangencia) {
	...
	/**
	 * Método acessor para obter o valor de posX
	 *
	...
	/**
	 * Método acessor para modificar o valor de posX
	 *
	...
	/**
	 * Método acessor para obter o valor de posY
	 *
	...
	/**
	 * Método acessor para modificar o valor de posY
	 *
	...
	/**
	 * Método acessor para obter o valor de pesos
	 *
	...
	/**
	 * Método acessor para modificar o valor de pesos
	 *
