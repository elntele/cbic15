 ...
 * Nome				Data		Descrição
 * ****************************************************************************
 * Danilo Araújo	16/10/2013		Versão inicial
 * ****************************************************************************
 */
package br.cns.gui;
...
import br.cns.experiments.ApplicationFrame;
import br.cns.experiments.ComplexNetwork;
import br.cns.experiments.MenuActions;
import br.cns.experiments.PrintUtilities;
import br.cns.experiments.StatusBar;
import br.cns.experiments.Util;
import br.cns.metrics.ClusteringCoefficientEntropy;
...
//	private static final String strNet = "Iris";
	...
	private PlaningResult getLinhas(int nodes) {
		...
		Double[][] b = null;
		try {
			File file2 = new File("C:/doutorado/submissões/computer_comm15/exps/ds/results_new/0t_l80_IowaStatewideFiberMap.gml/tg_pgeo_IowaStatewideFiberMap.gml-0-var.txt");
			File file3 = new File("C:/doutorado/submissões/computer_comm15/exps/ds/results_new/0t_l80_IowaStatewideFiberMap.gml/tg_pgeo_IowaStatewideFiberMap.gml-0-pf.txt");
			
//			File file2 = new File("C:/doutorado/submissões/computer_comm15/exps/ds/results_new/0t_l40_Iris.gml/tg_geok_Iris.gml-0-var.txt");
//			File file3 = new File("C:/doutorado/submissões/computer_comm15/exps/ds/results_new/0t_l40_Iris.gml/tg_geok_Iris.gml-0-pf.txt");
			
//			File file2 = new File("C:/doutorado/submissões/computer_comm15/exps/ds/moea/0/_top_M3_50_1,00_0,06_1.000_var.txt");
//			File file3 = new File("C:/doutorado/submissões/computer_comm15/exps/ds/moea/0/_top_M3_50_1,00_0,06_1.000_pf.txt");
...
//		File file1 = new File("C:\\doutorado\\datasets\\internet topology\\");
		File file1 = new File("C:/doutorado/submissões/complenet_2015/exps/ds/");
		...
		if (generateSummary) {
			...
			try {
				FileWriter fw = new FileWriter(new File(
						"C:/doutorado/submissões/elsarticle/eaai_2014/experiments/summary_nsgaii_nu.txt"));
				fw.write(sb1.toString());
				fw.close();
				fw = new FileWriter(new File(
						"C:/doutorado/submissões/elsarticle/eaai_2014/experiments/summary_nsgaii_nu_nds.txt"));
	...
	private void abrirRede() {
		...
		if (returnVal == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				JOptionPane.showMessageDialog(this.canvas, "Arquivo inválido!");
			}
		}
	}
