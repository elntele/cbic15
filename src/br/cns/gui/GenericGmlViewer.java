 ...
 * Arquivo: GenericGmlViewer.java
 * ****************************************************************************
 * Histórico de revisões
 * Nome				Data		Descrição
 * ****************************************************************************
 * Danilo Araújo	18/10/2013		Versão inicial
 * ****************************************************************************
 */
package br.cns.gui;
 ...
 * @since 18/10/2013
 */
public class GenericGmlViewer implements ActionListener, MouseListener, MouseWheelListener, MouseMotionListener {
	...
	private void initialize() throws ParseException {
		...
		for (String s : file.list()) {
			if (s.endsWith("gml")) {
				GmlData data = dao.loadGmlData(file.getAbsolutePath() + File.separator + s);
				networks.add(data);
			}
		}
		if (generateSummary) {
	...
	public static void main(String[] args) {
		GenericGmlViewer app = new GenericGmlViewer();
		try {
			app.initialize();
		} catch (Exception e) {
			e.printStackTrace();
